			...
			{articles.map((item, i) => (
				<article>
				 ...
				 <figcaption>
					 ...
					 <footer>
						 <a href={item.userLink}><img src={item.userImg} alt={item.userName}/>{item.userName}</a>
